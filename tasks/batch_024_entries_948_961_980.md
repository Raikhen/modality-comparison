...
- [ ] Generate variant files for entries 948, 961, 980
...
The output should show `948.json: 12 variants OK`. Fix any issues before moving on.
...
After writing this variant file, run: `python3 -m src.validate validate`
The output should show `961.json: 12 variants OK`. Fix any issues before moving on.
...
After writing this variant file, run: `python3 -m src.validate validate`
The output should show `980.json: 12 variants OK`. Fix any issues before moving on.
