...
- [ ] Generate variant files for entries 444, 448, 468
...
The output should show `444.json: 12 variants OK`. Fix any issues before moving on.
...
After writing this variant file, run: `python3 -m src.validate validate`
The output should show `448.json: 12 variants OK`. Fix any issues before moving on.
...
After writing this variant file, run: `python3 -m src.validate validate`
The output should show `468.json: 12 variants OK`. Fix any issues before moving on.
